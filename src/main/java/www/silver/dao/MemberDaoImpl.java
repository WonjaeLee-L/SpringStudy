...
// 서비스단에서 디비작업위해 emeberdaoimpl 객체 필요하고 이 객체는 IF_memberdao가 정의함.
...
//		sqlSession.insert("maaper와 매핑정보, mapper에 있는 여러 쿼리 중에서 쿼리 선택하기", "mapper의 parametertype에 넘길 파라미터값");
